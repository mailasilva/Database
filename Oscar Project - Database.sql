...
select * from Actor drop table Actor
select * from Movie drop table Movie
select * from Award drop table Award
select * from Director drop table Director
select * from Participation drop table Participation
select * from Premiation  drop table Premiation
